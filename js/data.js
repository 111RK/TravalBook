...
const PDF_TEMPLATES = [
  ...
  {
    id: 'square',
    name: 'Carré Instagram',
    desc: '21x21cm, idéal pour impression',
...
// Citations célèbres par lieu (pour le PDF)
const QUOTES = {
  "Portugal": [
    {text: "Lisbonne est une ville qui garde les yeux ouverts sur la mer, comme si elle attendait encore le retour de ses navigateurs.", attr: "José Saramago"},
    {text: "Le Fado n'est pas triste, il est la nostalgie d'un bonheur qu'on vit encore.", attr: "Amália Rodrigues"},
    {text: "Voyager, c'est découvrir que tout le monde a tort.", attr: "Aldous Huxley"}
  ],
  "Japon": [
    {text: "Le Japon est le pays où la tradition et la modernité dansent un tango permanent.", attr: "Amélie Nothomb"},
    {text: "À Tokyo, le silence est un luxe que l'on s'offre entre deux tempêtes de néons.", attr: "Haruki Murakami"},
    {text: "Chaque temple raconte mille ans d'histoire dans un murmure.", attr: "Proverbe japonais"}
  ],
  "Égypte": [
    {text: "L'Égypte est un don du Nil.", attr: "Hérodote"},
    {text: "Devant les pyramides, on comprend que l'homme a toujours rêvé plus grand que lui.", attr: "Victor Hugo"},
    {text: "Le désert enseigne la patience et l'émerveillement.", attr: "Antoine de Saint-Exupéry"}
  ]
};
...
const COUNTRY_COLORS = {
  ...
  "Égypte": {bg: [245,235,210], accent: [200,160,80], dark: [80,60,30]}
};
...
const VOYAGES = [
  {
    ...
    badge:"ok", cover:IMG.lisbon1, style:"Poétique",
    chapters:[
      { day:"Jour 1", title:"Belém, où le temps s'arrête",
        ...
        food:{name:"Pastéis de Nata",desc:"Délicieux flans pâtissiers croustillants, spécialité de Belém, à déguster tièdes saupoudrés de cannelle"},
        faces:["raph","marie"],
      ...
      { day:"Jour 2", title:"Alfama et les larmes du Fado",
        ...
        food:{name:"Sardines grillées",desc:"Sardines fraîches grillées au charbon, servies avec du pain et un filet de citron — l'âme de Lisbonne"},
        faces:["raph","marie"],
      ...
      { day:"Jour 3", title:"Sintra, le palais des rêves",
        ...
        food:{name:"Travesseiros de Sintra",desc:"Pâtisserie feuilletée fourrée à la crème d'amande et aux œufs, spécialité emblématique de Sintra"},
        faces:["raph","marie"],
      ...
      { day:"Jour 4", title:"Cascais, le souffle de l'océan",
        ...
        food:{name:"Polvo à Lagareiro",desc:"Poulpe grillé à l'huile d'olive et à l'ail, accompagné de pommes de terre écrasées — un classique du littoral"},
        faces:["raph","marie"],
      ...
      { day:"Jour 5", title:"Chiado, l'âme littéraire",
        ...
        food:{name:"Galão et Pastel de Feijão",desc:"Café latte portugais onctueux accompagné d'un gâteau aux haricots blancs, douceur typique des cafés du Chiado"},
        faces:["raph","marie"],
      ...
      { day:"Jour 6", title:"Le dernier miradouro",
        ...
        food:{name:"Ginjinha",desc:"Liqueur de cerise griotte servie dans un petit verre en chocolat — le rituel du soir à Lisbonne"},
        faces:["raph","marie"],
  ...
  },
  {
    ...
    chapters:[
      { day:"Jour 1", title:"Asakusa : le choc des mondes",
        ...
        food:{name:"Ramen Tonkotsu",desc:"Bouillon de porc crémeux, nouilles fermes, œuf mollet et chashu fondant — le réconfort ultime après un vol de 12 heures"},
      ...
      { day:"Jour 2", title:"Golden Gai : 200 bars, 6 places",
        ...
        food:{name:"Yakitori",desc:"Brochettes de poulet grillées au charbon de bois, parfaites avec un verre de whisky japonais dans les bars du Golden Gai"},
        faces:["raph","lucas","emma"],
      ...
      { day:"Jour 3", title:"Nikko sous la neige",
        ...
        food:{name:"Yuba (peau de tofu)",desc:"Spécialité de Nikko : fines feuilles de tofu frais servies en sashimi ou en soupe, délicatesse végétale unique"},
        faces:["raph","lucas","emma"],
      ...
      { day:"Jour 4", title:"Shibuya : le pouls de la capitale",
        ...
        food:{name:"Okonomiyaki",desc:"Crêpe japonaise garnie de chou, porc, crevettes et nappée de sauce sucrée — le street food incontournable de Tokyo"},
        faces:["raph","lucas","emma"],
  ...
  },
  {
    ...
    badge:"ok", cover:IMG.pyramids, style:"Poétique",
    chapters:[
      { day:"Jour 1", title:"Le Caire, le vertige des sens",
        ...
        food:{name:"Koshari",desc:"Plat national égyptien : mélange de riz, lentilles, pâtes et oignons frits, nappé de sauce tomate épicée"},
        faces:["raph","marie"],
      ...
      { day:"Jour 2-3", title:"Gizeh : face à l'éternité",
        ...
        food:{name:"Ful Medames",desc:"Fèves mijotées à l'huile d'olive, citron et cumin — le petit-déjeuner des pharaons modernes, servi depuis des millénaires"},
        faces:["raph","marie"],
      ...
      { day:"Jour 4-5", title:"Louxor, la cité des dieux",
        ...
        food:{name:"Moloukhia",desc:"Soupe de corète potagère à l'ail et à la coriandre, servie avec du riz — plat traditionnel de Haute-Égypte"},
        faces:["raph","marie"],
      ...
      { day:"Jour 6", title:"Assouan, la douceur du Sud",
        ...
        food:{name:"Thé à la menthe nubien",desc:"Thé noir infusé à la menthe fraîche et au sucre, servi dans un verre fumant sur le marché d'Assouan"},
        faces:["raph","marie"],
      ...
      { day:"Jour 7", title:"Abou Simbel : le lever du roi",
        ...
        food:{name:"Feteer Meshaltet",desc:"Pâte feuilletée croustillante servie sucrée au miel ou salée au fromage — le croissant égyptien, cuit au feu de bois"},
        faces:["raph","marie"],
      ...
      { day:"Jour 8-9", title:"Hurghada : le bleu infini",
        ...
        food:{name:"Poisson grillé de la Mer Rouge",desc:"Poisson frais du jour grillé aux épices, servi avec du riz safranné et une salade tahini en bord de mer"},
        faces:["raph","marie"],
      ...
      { day:"Jour 10", title:"Le Caire, les adieux",
        ...
        food:{name:"Kunafa",desc:"Dessert de cheveux d'ange croustillants fourrés au fromage doux, nappé de sirop de fleur d'oranger — pure gourmandise"},
        faces:["raph","marie"],
